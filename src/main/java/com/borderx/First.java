...
//                .setRetryHandler(new DefaultHttpRequestRetryHandler())
    ...
    public static void buy() {
        int count = 0;
        while(true) {
            String listStr = request("https://pet-chain.baidu.com/data/market/queryPetsOnSale", "{\"pageNo\":1,\"pageSize\":20,\"querySortType\":\"AMOUNT_ASC\",\"petIds\":[],\"lastAmount\":null,\"lastRareDegree\":null,\"requestId\":1517729851864,\"appId\":1,\"tpl\":\"\"}");
